...
\resumeSubheading
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      	\resumeItem{}
          {Accepted and managed donated items from customers}
        \resumeItem{}
          {Judging the saleability of items selling and culling stagnant inventory}
        \resumeItem{}
...
\section{Projects \& Coursework}
  \resumeSubHeadingListStart
    \resumeSubheading
      {3D Printing DLP Post Slice Supporter Group Project}{\href{https://github.com/spe-uob/3DPrinting}{github.com/spe-uob/3DPrinting}}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{}
          {Successfully used Scikit-Learn and NumPy libraries to implement maximum likelihood estimates, linear and non-linear least squares regression in practical examples}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
